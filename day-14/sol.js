// special thanks to /u/SkiFire13 with https://www.reddit.com/r/adventofcode/comments/eaz5et/js_day_14_part_2_is_within_7_fuel_from_answer/fb202hv/ , for finding a lot of bugs
// setup {{{
let aocInput;
{
  const fs = require('fs');
...
const sol2 = (input) => {
  ...
  while (ore >= 0) {
    ++step;
    const famount = Math.max(1, Math.floor(ore / orePerFuel));
